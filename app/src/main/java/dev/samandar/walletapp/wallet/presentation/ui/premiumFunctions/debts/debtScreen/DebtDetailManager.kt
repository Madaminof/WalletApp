...
import dev.samandar.walletapp.wallet.presentation.ui.premiumFunctions.debts.detail.DebtDetailBottomSheet
    ...
    DebtDetailBottomSheet(
        ...
        onEdit = {debt ->
            ...
            navController.navigate(
                Screen.ADD_EDIT_DEBT_SCREEN.route + "?debtId=${debt.id}&debtType=${debt.type.name}"
            )
        },
        onDelete = {
            onDismiss()
